...
def myNetwork():
    ...
    net.addLink(r1, h1, bw=0.01)
    net.addLink(r1, h2, bw=0.01)
    net.addLink(r1, h3, bw=0.01)
    net.addLink(r1, h4, bw=0.01)
    net.addLink(r1, h5, bw=0.01)
    net.addLink(r1, h6, bw=0.01)
    ...
    r1.cmd('python3 -u server_p2p.py > server_p2p2.log 2>&1 &')
    time.sleep(1)
    h1.cmd('python3 -u client_p2p.py -n h1 -i 192.168.10.2 -p 12000 &')
    h2.cmd('python3 -u client_p2p.py -n h2 -i 192.168.20.2 -p 12000 &')
    h3.cmd('python3 -u client_p2p.py -n h3 -i 192.168.30.2 -p 12000 &')
    h4.cmd('python3 -u client_p2p.py -n h4 -i 192.168.40.2 -p 12000 &')
    h5.cmd('python3 -u client_p2p.py -n h5 -i 192.168.50.2 -p 12000 &')
    h6.cmdPrint('python3 client_p2p.py -n h6 -i 192.168.60.2 -p 12000')
