...
class SingleSwitchTopo(Topo):
    def build(self):
        ...
        self.addLink(host1, switch1, bw=50, delay='5ms', loss=0.1, use_htb=True)
        self.addLink(host2, switch2, bw=50, delay='5ms', loss=0.1, use_htb=True)
        self.addLink(switch1, switch2, bw=50, delay='50ms', loss=0.1, use_htb=True)
...
def Test(tcp):
    ...
    _serverbw, clientbw = net.iperf([h1, h2], seconds=100)
    info(clientbw, '\n')
    # CLI(net)
    net.stop()
